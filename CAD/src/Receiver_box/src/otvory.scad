...
module SMA_panel(tloustka_bocnice,vzdalenost_der,vyska_bocnice)
{
SMA_dia = 6.1;
SMA_flat = 3.15;
   ...
   translate([0,0,vyska_bocnice/2])
      rotate([90,0,0]) {
          difference  () {
              cylinder (h = 2*tloustka_bocnice, r= SMA_dia/2, $fn=50, center=true);
                  translate([ 0, SMA_flat , 0 ]) 
                      cube([SMA_dia, 1 , 10 ], center=true);
          }
      }    
}
