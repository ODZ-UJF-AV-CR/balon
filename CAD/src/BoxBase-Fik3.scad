...
*/ 
       ...
       translate([ot+MLAB_grid*b/2, o+MLAB_grid*1.5, tld])
...
// Přepážka 1 - u otvoru na dráty
 ...
 // Přepážka 2
       translate([ot+MLAB_grid*8+o/2-59, o+MLAB_grid*1.5, vp/2])
       cube([tp, MLAB_grid*(a)-0.6, vp], center = true);

// Trubky
    translate([ot+MLAB_grid*1, o, vt/2])
    difference() {
           cylinder(vt, pt/2, pt/2, center = true);
       translate([0, 0, vt/2])
           cylinder(16, po/2, po/2, center = true); }

    translate([ot+MLAB_grid*8, o+MLAB_grid*3, vt/2])
    difference() {
           cylinder(vt, pt/2, pt/2, center = true);
       translate([0, 0, vt/2])
           cylinder(16, po/2, po/2, center = true); }

    translate([ot+MLAB_grid*1, o+MLAB_grid*3, vt/2])
    difference() {
           cylinder(vt, pt/2, pt/2, center = true);
       translate([0, 0, vt/2])
           cylinder(16, po/2, po/2, center = true); }

    translate([ot+MLAB_grid*8, o+MLAB_grid*0, vt/2])
    difference() {
           cylinder(vt, pt/2, pt/2, center = true);
       translate([0, 0, vt/2])
           cylinder(16, po/2, po/2, center = true); }
